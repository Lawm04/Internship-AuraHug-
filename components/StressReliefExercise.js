  ...
  return (
    ...
    <section className="py-12 px-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        {/* Guided Meditations */}
        <div className="p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition">
          <h3 className="text-2xl font-semibold mb-4">Guided Meditations</h3>
    ...
    <section className="py-12 px-6 bg-gray-100">
      <h2 className="text-3xl font-bold text-center mb-8">Featured Exercise</h2>
      <div className="p-6 bg-white rounded-lg shadow-md max-w-xl mx-auto text-center">
        <h3 className="text-2xl font-semibold mb-4">2-Minute Breathing Exercise</h3>
    ...
    <section className="py-12 px-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="p-6 rounded-xl bg-gradient-to-tr from-blue-100 to-purple-200 shadow-lg relative overflow-hidden">
          <h3 className="text-xl font-bold mb-4">Breathing Timer</h3>
        ...
        <div className="p-6 rounded-xl bg-gradient-to-tr from-orange-100 to-yellow-200 shadow-lg relative">
          <h3 className="text-xl font-bold mb-4">Meditation Player</h3>
