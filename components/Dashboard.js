    ...
    <div className="flex flex-col flex-1 gap-8 sm:gap-12 md:gap-16 ">
      ...
      >
        ...
        <div className="p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition">
          ...
          <p className="text-gray-700 mb-4">Easily log your mood in seconds to recognize emotional patterns over time.</p>
          <button 
        ...
        <div className="p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition">
          ...
          <p className="text-gray-700 mb-4">Take a moment to reflect on your feelings, energy, and gratitude each day.</p>
          <button 
